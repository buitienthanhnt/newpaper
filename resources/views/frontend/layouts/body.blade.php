                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="slider-active">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src={{ asset('assets/frontend/img/trending/trending_top2.jpg') }}
                                            alt="">
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src={{ asset('assets/frontend/img/trending/trending_top02.jpg') }}
                                            alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s"
                                                data-duration="1000ms">Business</span>
                            ...
                            <div class="single-slider">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src={{ asset('assets/frontend/img/trending/trending_top03.jpg') }}
                                            alt="">
                                        <div class="trend-top-cap">
                                            <span class="bgr" data-animation="fadeInUp" data-delay=".2s"
                                                data-duration="1000ms">Business</span>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src={{ asset('assets/frontend/img/trending/trending_top3.jpg') }}
                                            alt="">
                            ...
                            <div class="col-lg-12 col-md-6 col-sm-6">
                                <div class="trending-top mb-30">
                                    <div class="trend-top-img">
                                        <img src={{ asset('assets/frontend/img/trending/trending_top4.jpg') }}
                                            alt="">
                                        <div class="trend-top-cap trend-top-cap2">
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="whats-news-single mb-40 mb-40">
                                                    <div class="whates-img">
                                                        <img src={{ asset('assets/frontend/img/gallery/whats_news_details1.png') }}
                                                            alt="">
                                                    </div>
                                            ...
                                            <div class="col-xl-6 col-lg-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src={{ asset('assets/frontend/img/gallery/whats_right_img1.png') }}
                                                                    alt="">
                                                            </div>
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src={{ asset('assets/frontend/img/gallery/whats_right_img3.png') }}
                                                                    alt="">
                                                            </div>
                                                            <div class="whats-right-cap">
                                                    ...
                                                    <div class="col-xl-12 col-lg-6 col-md-6 col-sm-10">
                                                        <div class="whats-right-single mb-20">
                                                            <div class="whats-right-img">
                                                                <img src={{ asset('assets/frontend/img/gallery/whats_right_img4.png') }}
                                                                    alt="">
                                                            </div>
                                                            <div class="whats-right-cap">
                        ...
                        <div class="single-box">
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="#"><img src={{ asset('assets/frontend/img/news/icon-fb.png') }}
                                            alt=""></a>
                                </div>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="#"><img src={{ asset('assets/frontend/img/news/icon-tw.png') }}
                                            alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="#"><img src={{ asset('assets/frontend/img/news/icon-ins.png') }}
                                            alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                            ...
                            <div class="follow-us d-flex align-items-center">
                                <div class="follow-social">
                                    <a href="#"><img src={{ asset('assets/frontend/img/news/icon-yo.png') }}
                                            alt=""></a>
                                </div>
                                <div class="follow-count">
                                    <span>8,045</span>
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-5 col-sm-7">
                        <div class="single-footer-caption mb-50">
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src={{ asset('assets/frontend/img/gallery/footer_post1.png') }}
                                        alt="">
                                </div>
                                <div class="whats-right-cap">
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src={{ asset('assets/frontend/img/gallery/footer_post2.png') }}
                                        alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a>
                            ...
                            <div class="whats-right-single mb-20">
                                <div class="whats-right-img">
                                    <img src={{ asset('assets/frontend/img/gallery/footer_post3.png') }}
                                        alt="">
                                </div>
                                <div class="whats-right-cap">
                                    <h4><a href="latest_news.html">Scarlett’s disappointment at latest accolade</a>

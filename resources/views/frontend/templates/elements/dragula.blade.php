...
<h1><a href='https://github.com/bevacqua/dragula'><img src='{{ asset('assets/frontend/img/dragula/resources/logo.svg')}}'
            alt='dragula' /></a></h1>
...
<div class='examples'>
    {{-- <script async type="text/javascript"
        src="//cdn.carbonads.com/carbon.js?zoneid=1673&serve=C6AILKT&placement=githubcombevacqua" id="_carbonads_js">
    </script> --}}
    <div class='parent'>
    ...
    <div class='parent'>
        ...
        <div class='wrapper'>
            <div id='left-events' class='container'>
                ...
                <div>Whenever an element is cloned because <code>copy: true</code>, a <code>cloned</code> event fires
                </div>
            ...
            <div id='right-events' class='container'>
                ...
                <div>The <code>over</code> event fires when you drag something over a container, and <code>out</code>
                    fires when you drag it away from the container</div>
                <div>Lastly, a <code>dragend</code> event is fired whenever a drag operation ends, regardless of whether
    ...
    <div class='parent'>
        ...
        <div class='wrapper'>
            <div id='left-rollbacks' class='container'>
                ...
                <div>If you try to drop an item outside of any containers, though, it'll retain its original position
                </div>
    ...
    <div class='parent'>
        ...
        <div class='wrapper'>
            ...
            <div id='right-lovehandles' class='container'>
                <div><span class='handle'>+</span>This might also be useful if you want multiple children of an element
  ...
  moves: function (el, container, handle) {
    return handle.className === 'handle';
        ...
        <div>There are a few similar mechanisms to determine whether an element can be dragged from a certain container
            <a href='https://github.com/bevacqua/dragula#optionsmoves'>(<code>moves</code>)</a>, whether an element can
...
{{-- <script src='{{ asset('assets/frontend/js/dragula/dragula.js') }}'></script> --}}
{{-- <script src='{{ asset('assets/frontend/js/dragula/example.js') }}'></script> --}}

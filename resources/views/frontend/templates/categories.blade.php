    ...
    <div class="trending-top mb-30">
        <div class="trend-top-img">
            ...
            <div class="trend-top-cap trend-top-cap2">
                <span class="bgg">{{ $tren_r->to_category()->first() ?
                    $tren_r->to_category()->first()->for_category()->first()->name: '' }}</span>
                        ...
                        <div class="col-xl-6">
                            <div class="whats-news-single mb-20">
                                ...
                                <div class="whates-caption">
                                    <h4><a
                                            href="{{ route('front_page_detail', ['alias' => $paper_first->url_alias, 'page' => $paper_first->id]) }}">{{
                                            $paper_first->title }}</a>
                                    </h4>
                                    <h6>{{ $paper_first->short_conten }}</h6>
                                    <p>by
                                        <a href="" class="text text-info">
                                            {{ $paper_first->to_writer()->getResults() ?

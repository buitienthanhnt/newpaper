    ...
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                <h1 class="welcome-text">Xin chào! <span class="text-black fw-bold">{{ $list_data['user']->name ?? '' }}</span></h1>
        ...
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link count-indicator" id="notificationDropdown" href={{ asset('assets/adminhtml/#') }}
            ...
            <li class="nav-item dropdown">
                <a class="nav-link count-indicator" id="countDropdown" href={{ asset('assets/adminhtml/#') }}
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href={{ asset('assets/adminhtml/#') }}
                    data-bs-toggle="dropdown" aria-expanded="false">
                    <img class="img-xs rounded-circle" src={{ asset('assets/adminhtml/images/faces/face8.jpg') }}
                        alt="Profile image"> </a>
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                    ...
                    <a class="dropdown-item" href="{{ route('admin_logout') }}"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign
                        Out</a>
                </div>
            </li>
        </ul>

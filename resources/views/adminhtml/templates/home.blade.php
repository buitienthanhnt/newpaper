                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="d-flex justify-content-between align-items-center mb-2 mb-sm-0">
                                            ...
                                            <div>
                                                <p class="text-small mb-2">Total Visitors
                                                </p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div>
                                                <p class="text-small mb-2">Visits per day
                                                </p>
                                    ...
                                    <table class="table select-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex ">
                                                        <img src={{ asset('assets/adminhtml/images/faces/face1.jpg') }}
                                                            alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <img src={{ asset('assets/adminhtml/images/faces/face2.jpg') }}
                                                            alt="">
                                                        <div>
                                                            <h6>Laura Brooks</h6>
                                                            <p>Head admin</p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <img src={{ asset('assets/adminhtml/images/faces/face3.jpg') }}
                                                            alt="">
                                                        <div>
                                                            <h6>Wayne Murphy</h6>
                                                            <p>Head admin</p>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <img src={{ asset('assets/adminhtml/images/faces/face4.jpg') }}
                                                            alt="">
                                                        <div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <img src={{ asset('assets/adminhtml/images/faces/face5.jpg') }}
                                                            alt="">
                                                        <div>
                                    ...
                                    <li>
                                        <div class="d-flex justify-content-between">
                                            <div><span class="text-light-green">Ben
                                                    Tossell</span> assign you a task</div>
                                            <p>Just now</p>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="d-flex justify-content-between">
                                            <div><span class="text-light-green">Jack
                                                    William</span> assign you a task</div>
                                            <p>1h</p>
                                        </div>
                                    </li>
                                    <li>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton3">
                                                        ...
                                                        <a class="dropdown-item"
                                                            href={{ asset('assets/adminhtml/#') }}>Year
                                                            Wise</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mt-3">
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    <img class="img-sm rounded-10"
                                                        src={{ asset('assets/adminhtml/images/faces/face1.jpg') }}
                                                        alt="profile">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    <img class="img-sm rounded-10"
                                                        src={{ asset('assets/adminhtml/images/faces/face2.jpg') }}
                                                        alt="profile">
                                                    <div class="wrapper ms-3">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    <img class="img-sm rounded-10"
                                                        src={{ asset('assets/adminhtml/images/faces/face3.jpg') }}
                                                        alt="profile">
                                                    <div class="wrapper ms-3">
                                                        <p class="ms-1 mb-1 fw-bold">
                                                            Katherine Butler</p>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    <img class="img-sm rounded-10"
                                                        src={{ asset('assets/adminhtml/images/faces/face4.jpg') }}
                                                        alt="profile">
                                                    <div class="wrapper ms-3">
                                                        <p class="ms-1 mb-1 fw-bold">
                                                            Matthew Bailey</p>

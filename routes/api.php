...
Route::prefix('share')->group(function () use($extensionController){
    ...
    Route::get("mostPopulator", $extensionController.ExtensionControllerInterface::MOST_POPULATOR_HTML)->name('api_most_populator');

    // https://localhost/laravel1/public/api/share/likeMost
    Route::get("likeMost", $extensionController.ExtensionControllerInterface::MOST_LIKE_HTML)->name('api_like_most');

    // https://localhost/laravel1/public/api/share/trending
    Route::get('trending', $extensionController.ExtensionControllerInterface::MOST_TRENDING_HTML)->name("api_trending");
});
...
Route::prefix('paper')->group(function ()use($extensionController, $paperFrontController) {
    ...
    Route::post("like/{comment_id?}", $paperFrontController.PaperFrontControllerInterface::FRONT_COMMENT_LIKE);
